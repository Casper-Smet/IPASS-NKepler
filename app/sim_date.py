...
# TODO visualise better, this is a mess

def animate(i):
    ax1.clear()
    ax1.set_ylim([axis_range * -1.1, axis_range * 1.1])
    ax1.set_xlim([axis_range * -1.1, axis_range * 1.1])
    ax1.scatter(scatter_able_pos0[0], scatter_able_pos0[1])
    ax1.scatter(scatter_able_updated_pos0[0], scatter_able_updated_pos0[1])
...
def calculate_orbit_system(focus):
    ...
    for sat in satellites:
        lambda_dict[sat.name] = sat.angular_displacement_at_t(True)
        trail_dict[sat.name] = [[], []]
...
if __name__ == '__main__':
    ...
    #
    # print(io.angular_displacement_to_coordinates(io.angular_displacement_at_t()(10)))
    # print(europa.angular_displacement_to_coordinates(europa.angular_displacement_at_t()(30)))
    # print(ganymede.angular_displacement_to_coordinates(ganymede.angular_displacement_at_t()(24 * 3)))
    # print(callisto.angular_displacement_to_coordinates(ganymede.angular_displacement_at_t()(24 * 12)))
